RSpec.describe NotionCapture::WriteNotionPageToGithubWorker, vcr: true do
  describe "#perform" do
    it "fetches the given Notion page and stores it in the temporary Git copy (but doesn't commit anything yet)" do
      NotionCapture.with_configuration(remote_url: "file://#{remote_repo_dir}", local_directory: local_repo_dir) do
        create_rugged_repo(
          directory: remote_repo_dir,
          files: {"foo" => "this is a foo"},
          commit: true
        )
        ...
        new_file_path = "722ba1ef-e17a-4175-90c6-dd123ddf11d4/12ba1ded-9372-45a3-adc9-ce985053d7a8.json"
