...
module NotionCapture
  class GitRepo
    ...
    def create_file_in_index!(file_path, content)
    ...
    def initialize_index!
      if rugged_repo.index.count > 0
        raise 'Please clear the index before calling #pushing_commit!.'
      end
    ...
    def commit!(message)
      if rugged_repo.index.count > 0
        ...
        raise 'Nothing to commit: index empty.'
      end
    end
